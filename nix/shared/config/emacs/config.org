...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Josh Wilson"
    user-mail-address "joshuef@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/josh/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/josh/bin" "/profile/bin" "/Users/josh/.npm-packages/bin" "/Users/josh/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
